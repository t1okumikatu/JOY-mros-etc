...
void subscription_callback(const void *msgin) {
  ...
  angular_velocity=msg->angular.z * 60;

  
  Lpwm=linear_velocity - (angular_velocity * 1.2);
  Rpwm=linear_velocity + (angular_velocity * 1.2);
...
void setup() {
  ...
  set_microros_wifi_transports("Buffalo-G-7900", "46uppwbxjnnnr", "192.168.100.128",8888);
